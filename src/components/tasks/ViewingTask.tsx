                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {task.subTasks.map(subTask => (
                                    <div key={subTask.id} className="px-4 text-sm py bg-accent/50 border-t border-b rounded whitespace-pre-wrap text-foreground justify-center items-center flex">
                                        <Checkbox className="mr-2" checked={subTask.completed} />
                                        {subTask.title}
                                    </div>
                                ))}
                            </div>
                            <div>
                                ...
                                {task.comments?.map((comment, index) => (
                                    <div key={index} className="px-4 text-sm py bg-accent/50 border-t border-b rounded whitespace-pre-wrap text-foreground justify-center items-center flex">
                                        {comment}
                                    </div>
                                ))}
